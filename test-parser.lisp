...
(defun test-parse-primitive-action-term (term action-name arity cc)
  (let ((parsed-term (parse-into-term-representation term cc)))
    (is (typep parsed-term 'primitive-action-term))
...
(deftest test-parse-into-term-representation-04 ()
  (let ((cc (make-instance 'compilation-unit)))
    (declare-primitive-action :prototype '(foo x t) :context cc)
...
(deftest test-parse-into-term-representation-08 ()
  (let ((cc (make-instance 'compilation-unit)))
    (declare-primitive-action :prototype '(foo direction) :context cc)
    (declare-primitive-action :prototype '(bar direction) :context cc)
...
(deftest test-parse-into-term-representation-10 ()
  (let ((cc (make-instance 'compilation-unit)))
    (declare-primitive-action :prototype '(foo dir1) :context cc)
    (declare-primitive-action :prototype '(bar dir1) :context cc)
    (let ((parsed-term (parse-into-term-representation
                        '(repeat (foo north))
                        cc)))
...
(deftest test-parse-into-term-representation-12 ()
  (let ((cc (make-instance 'compilation-unit)))
    (declare-primitive-action :prototype '(foo dir) :context cc)
    (let ((parsed-term (parse-into-term-representation
